...
<div >
 ...
 <div class="center">
     ...
     <!--   <h3>Select the report components:</h3> -->
                ...
                <form name="reportE_form">

                    <div>
                      <h5>What kind of file should be formed?</h5>
                    </div>
                    <div class="flipswitch">
                      <input type="checkbox" name="reportE_switch_pdf_or_xml" class="flipswitch-cb" id="fsE" checked>
                      <label class="flipswitch-label" for="fsE">
                      <div class="flipswitch-inner"></div>
                      <div class="flipswitch-switch"></div>
                      </label>
                    </div>
                    <div class="center">
                      <button  onclick="dateVeryfy6()" class="button" style="vertical-align:middle" name="reportE_button_send" > <span>SEND</span> </button>
                    </div>
                </form>
            </span>
